...
var Tools = []Tool{
	{Mode: GoInstall, Name: "tinygoinstall", Source: "github.com/tinywasm/tinygo/cmd/tinygoinstall", ModuleVersion: "v0.0.3", Version: "0.40.1", VerifyBinary: "tinygo", Required: true},
